...
// ROUTE 1: Create a User using : POST "api/coach/createuser".No login required
...
// ROUTE 2: Authenticate a User using: POST "api/coach/userlogin". Create user login required
...
// ROUTE 3: Get user loggedin Details using: POST "/api/coach/getuser". login details required 
