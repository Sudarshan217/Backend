...
// ROUTE 1: Create a User using : POST "api/admin/createuser".No login required
...
// ROUTE 2: Authenticate a User using: POST "api/admin/userlogin". Create user login required
...
// ROUTE 3: Get user loggedin Details using: POST "/api/admin/getuser". login details required 
