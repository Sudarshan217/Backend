...
// ROUTE 1: Create a User using : POST "api/controller/createuser".No login required
...
// ROUTE 2: Authenticate a User using: POST "api/controller/userlogin". Create user login required
...
// ROUTE 3: Get user loggedin Details using: POST "/api/controller/getuser". login details required 
